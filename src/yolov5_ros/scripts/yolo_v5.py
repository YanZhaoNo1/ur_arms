...
class Yolo_Dect:
    ...
    def image_callback(self, image):
        ...
        self.color_image = np.frombuffer(image.data, dtype=np.uint8).reshape(image.height, image.width, 3)
    ...
    def dectshow(self, org_img, boxs, height, width):
        ...
        for box in boxs:
            ...
            boundingBox.Class = class_to_num[box[-1]]
